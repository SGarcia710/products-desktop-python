...
class Product: 
	...
	def __init__(self,window): #Constructor
		...
		self.message.grid(row = 3, column = 0, columnspan = 2, sticky = W + E) #West to east
	...
	def edit_product(self):
		...
		# Button 
		ttk.Button(self.edit_wind, text = 'Update', command = lambda: self.edit_records(new_name.get(), name, new_price.get(), old_price)).grid(row = 4, column = 2, sticky = W)
